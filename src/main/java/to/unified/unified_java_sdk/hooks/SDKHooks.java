package to.unified.unified_java_sdk.hooks;
...
public final class SDKHooks {
    ...
    public static void initialize(to.unified.unified_java_sdk.utils.Hooks hooks) {
    ...
    public static void initialize(to.unified.unified_java_sdk.utils.AsyncHooks asyncHooks) {
        ...
        // asyncHooks.registerAfterError(to.unified.unified_java_sdk.utils.HookAdapters.adapt(mySyncHook));
