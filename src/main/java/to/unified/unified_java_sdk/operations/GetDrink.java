...
public class GetDrink {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetDrinkRequest, GetDrinkResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetDrinkRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetDrinkRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetDrinkRequest request) {
        ...
        @Override
        public GetDrinkResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetDrinkResponse.Builder resBuilder =
                    GetDrinkResponse
                            .builder()
            ...
            GetDrinkResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDrink(Utils.unmarshal(response, new TypeReference<Drink>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetDrinkRequest, to.unified.unified_java_sdk.models.operations.async.GetDrinkResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetDrinkRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetDrinkRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetDrinkRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetDrinkResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetDrinkResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetDrinkResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetDrinkResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<Drink>() {})
                            .thenApply(res::withDrink);
                } else {
