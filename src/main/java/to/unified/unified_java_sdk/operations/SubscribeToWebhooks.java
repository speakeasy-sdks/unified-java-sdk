...
public class SubscribeToWebhooks {
    ...
    public static class Sync extends Base
            implements RequestOperation<List<RequestBody>, SubscribeToWebhooksResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(List<RequestBody> request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<List<RequestBody>>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(List<RequestBody> request) {
        ...
        @Override
        public SubscribeToWebhooksResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            SubscribeToWebhooksResponse.Builder resBuilder =
            ...
            SubscribeToWebhooksResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<List<RequestBody>, to.unified.unified_java_sdk.models.operations.async.SubscribeToWebhooksResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(List<RequestBody> request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<List<RequestBody>>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(List<RequestBody> request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.SubscribeToWebhooksResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.SubscribeToWebhooksResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.SubscribeToWebhooksResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.SubscribeToWebhooksResponse res = resBuilder.build();
