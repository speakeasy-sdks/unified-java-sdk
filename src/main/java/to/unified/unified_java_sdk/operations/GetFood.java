...
import to.unified.unified_java_sdk.models.operations.GetFoodResponseBody;
...
public class GetFood {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetFoodRequest, GetFoodResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetFoodRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetFoodRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetFoodRequest request) {
        ...
        @Override
        public GetFoodResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetFoodResponse.Builder resBuilder =
                    GetFoodResponse
                            .builder()
            ...
            GetFoodResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<GetFoodResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetFoodRequest, to.unified.unified_java_sdk.models.operations.async.GetFoodResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetFoodRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetFoodRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetFoodRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetFoodResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetFoodResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetFoodResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetFoodResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetFoodResponseBody>() {})
