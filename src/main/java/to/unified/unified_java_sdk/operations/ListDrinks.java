...
public class ListDrinks {
    ...
    static abstract class Base {
        ...
        <T>HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            ...
            req.addQueryParams(Utils.getQueryParams(
                    ...
                    request,
                    null));
            Utils.configureSecurity(req, this.sdkConfiguration.securitySource().getSecurity(), "clientCredentials");
    ...
    public static class Sync extends Base
            implements RequestOperation<ListDrinksRequest, ListDrinksResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ListDrinksRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListDrinksRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListDrinksRequest request) {
        ...
        @Override
        public ListDrinksResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListDrinksResponse.Builder resBuilder =
                    ListDrinksResponse
                            .builder()
            ...
            ListDrinksResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDrinks(Utils.unmarshal(response, new TypeReference<List<Drink>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListDrinksRequest, to.unified.unified_java_sdk.models.operations.async.ListDrinksResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListDrinksRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListDrinksRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListDrinksRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListDrinksResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListDrinksResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListDrinksResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListDrinksResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<Drink>>() {})
                            .thenApply(res::withDrinks);
                } else {
