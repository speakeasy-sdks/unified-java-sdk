...
public class CreateOrder {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateOrderRequest, CreateOrderResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CreateOrderRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateOrderRequest.class, new TypeReference<CreateOrderRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateOrderRequest request) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateOrderRequest, to.unified.unified_java_sdk.models.operations.async.CreateOrderResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CreateOrderRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateOrderRequest.class, new TypeReference<CreateOrderRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateOrderRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateOrderResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateOrderResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateOrderResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateOrderResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<Order>() {})
                            .thenApply(res::withOrder);
                } else {
