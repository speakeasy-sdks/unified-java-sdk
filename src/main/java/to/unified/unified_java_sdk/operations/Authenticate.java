...
import to.unified.unified_java_sdk.models.operations.AuthenticateResponseBody;
...
public class Authenticate {
    ...
    public static class Sync extends Base
            implements RequestOperation<AuthenticateRequestBody, AuthenticateResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AuthenticateRequestBody request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<AuthenticateRequestBody>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AuthenticateRequestBody request) {
        ...
        @Override
        public AuthenticateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AuthenticateResponse.Builder resBuilder =
            ...
            AuthenticateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<AuthenticateResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AuthenticateRequestBody, to.unified.unified_java_sdk.models.operations.async.AuthenticateResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AuthenticateRequestBody request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<AuthenticateRequestBody>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AuthenticateRequestBody request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.AuthenticateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.AuthenticateResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.AuthenticateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.AuthenticateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<AuthenticateResponseBody>() {})
