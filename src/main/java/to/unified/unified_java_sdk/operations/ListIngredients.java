...
import to.unified.unified_java_sdk.models.operations.ListIngredientsResponseBody;
...
public class ListIngredients {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListIngredientsRequest, ListIngredientsResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ListIngredientsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListIngredientsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListIngredientsRequest request) {
        ...
        @Override
        public ListIngredientsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListIngredientsResponse.Builder resBuilder =
            ...
            ListIngredientsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<ListIngredientsResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListIngredientsRequest, to.unified.unified_java_sdk.models.operations.async.ListIngredientsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListIngredientsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListIngredientsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListIngredientsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListIngredientsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListIngredientsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListIngredientsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListIngredientsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ListIngredientsResponseBody>() {})
